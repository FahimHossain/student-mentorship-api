...
router.get(
  ...
  DbController.createStudentSkillListTable
);

/**
 * @description 13. Create Faculty task table
 * @endpoint http://localhost:2727/db/create-table/faculty_task
 * @example http://localhost:2727/db/create-table/faculty_task
 */
router.get("/create-table/faculty_task", DbController.createFacultyTaskTable);
